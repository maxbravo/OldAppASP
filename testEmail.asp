...
sql = sql & "ANEXOS = '" & Anexos & "', REFERENCIA='" & Referencia & "' where CODIGO = " & Cod
	...
	if Status = "Validado" then
	   ...
	   ' message body
	   Mail.IsHTML = True
	   body = "A New Incident has been registered.<br><b>Reference: </b> " & Referencia & "<br><b>Date: </b>" & Fecha & " " & Hora & "<br><b>Localion: </b> " & Provincia & " - " & Ciudad & "<br><b>Registered by: </b> " & Auditoria & "<br><br><a target='_blank' href=http://uioap009.andespetro.com/sits/view.asp?action=view&codigo=" & Cod & ">If you want to view this new incident, please click here.</a>"
	   Mail.Body = body
	   ' send message
	   Mail.Send 
	   Set Mail = Nothing
