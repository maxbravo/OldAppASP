...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="860">
    <tr>
    <td valign="top"><!-- ########### INCLUDE Sample Navigation ########### --><!-- #include file="includes/navigation2.htm" --></td>
...
<p class="banner_blue">Buscar Incidente Para Validarlo:</p>


<form method="POST" action="searchpending.asp?action=search" name="FrontPage_Form1" onsubmit="return FrontPage_Form1_Validator(this)" language="JavaScript">
...
%>
  <tr>
    ...
    <td bgcolor="#E7FEE0" align="center" width="10%"><a href="updatepending.asp?action=update&codigo=<%=RS.Fields("CODIGO")%>">
    <img src="images/edit.gif" border="0"></a></td>
    <td bgcolor="#E7FEE0" align="center" width="10%"><a href="searchpending.asp?action=delete&codigo=<%=RS.Fields("CODIGO")%>">
...
%>
<form method="POST" action="searchpending.asp?action=delete1&codigo=<%=Cod%>">
