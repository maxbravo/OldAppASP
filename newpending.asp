...
if (sel!=null) { 
    ...
    if (rng!=null) 
	  myRemote = launch("http://uioap009.andespetro.com/SITS/docs/temp/"+rng.text, "SITS", "height=400,width=400,channelmode=0,dependent=0,directories=1,fullscreen=0,location=1,menubar=0,resizable=1,scrollbars=0,status=0,toolbar=0", "myWindow");      
} 
} 
...
<form method="POST" name="FrontPage_Form1" action="newpending.asp?action=save" onsubmit="return FrontPage_Form1_Validator(this)" language="JavaScript" >
<table style="border-collapse: collapse" bordercolor="#111111" cellpadding="0" cellspacing="0" width="652" height="745">
  <tr>
    ...
    <!--webbot bot="Validation" s-display-name="Referencia" s-data-type="String" b-allow-letters="TRUE" b-allow-digits="TRUE" b-allow-whitespace="TRUE" b-value-required="TRUE" i-minimum-length="1" i-maximum-length="300" --><input name="Referencia" type="text"  size="80" maxlength="300"></td>
  </tr>
  ...
  <tr>
    ...
    <!--webbot bot="Validation" s-display-name="Hora" s-data-type="String" b-allow-digits="TRUE" s-allow-other-chars=":" b-value-required="TRUE" i-maximum-length="5" --><input name="Hora" type="text"  size="10" maxlength="5"></td>
  ...
  <tr>
    ...
    <!--webbot bot="Validation" s-display-name="Lugar_Específico" s-data-type="String" b-allow-letters="TRUE" b-allow-digits="TRUE" b-allow-whitespace="TRUE" s-allow-other-chars="-#" b-value-required="TRUE" i-minimum-length="1" i-maximum-length="500" --><textarea rows="3" name="Lugar" cols="68"></textarea></td>
  </tr>

  <tr>
    <td width="84" height="32"><span lang="es-ec">Elaborado por :</span></td>
    <td width="526" height="32" colspan="5">
    <!--webbot bot="Validation" s-display-name="Elaborado Por" s-data-type="String" b-allow-letters="TRUE" b-allow-digits="TRUE" b-allow-whitespace="TRUE" s-allow-other-chars="-#" b-value-required="TRUE" i-minimum-length="1" i-maximum-length="250" --><textarea rows="1" name="Razon" cols="68"></textarea></td>
  </tr>
  
  <tr>
    <td width="84" height="32"><span lang="es-ec">Reportado a :</span></td>
    <td width="526" height="32" colspan="5">
    <!--webbot bot="Validation" s-display-name="Reportado A" s-data-type="String" b-allow-letters="TRUE" b-allow-digits="TRUE" b-allow-whitespace="TRUE" s-allow-other-chars="-#" b-value-required="TRUE" i-minimum-length="1" i-maximum-length="250" --><input name="Reportadoa"  type="text"  size="29" maxlength="250"></td>
  </tr>  

  <tr>
    <td width="84" height="32">Reportado por:</td>
    <td width="176" height="32">
    <!--webbot bot="Validation" s-display-name="Reportado Por" s-data-type="String" b-allow-letters="TRUE" b-allow-digits="TRUE" b-allow-whitespace="TRUE" b-value-required="TRUE" i-minimum-length="1" i-maximum-length="250" --><input name="Fuente" type="text"  size="29" maxlength="250"></td>
    <td width="80" height="32" align="right">
  ...
  <tr>
    ...
    <!--webbot bot="Validation" s-display-name="Descripcion" s-data-type="String" b-allow-letters="TRUE" b-allow-digits="TRUE" b-allow-whitespace="TRUE" s-allow-other-chars="#-_." b-value-required="TRUE" i-minimum-length="1" i-maximum-length="2000" --><textarea rows="3" name="Descripcion" cols="68"></textarea></td>
  </tr>
  <tr>
    ...
    <!--webbot bot="Validation" s-display-name="Notificacion_Seguimiento" s-data-type="String" b-allow-letters="TRUE" b-allow-digits="TRUE" b-allow-whitespace="TRUE" s-allow-other-chars="#-_" i-maximum-length="2000" --><textarea rows="2" name="Seguimiento" cols="68"></textarea></td>
  </tr>
  ...
  <tr>
    ...
    <td width="568" align="left" height="31" colspan="5">
    <!--webbot bot="Validation" s-display-name="Acciones Tomadas" s-data-type="String" b-allow-letters="TRUE" b-allow-digits="TRUE" b-allow-whitespace="TRUE" s-allow-other-chars="#-_" i-maximum-length="2000" --><textarea rows="2" name="Acciones" cols="68"></textarea></td>
  </tr>  
  
  <tr>
    <td width="84" height="36">Personas AdPetro :</td>
    <td width="568" height="36" colspan="5">
    <!--webbot bot="Validation" s-display-name="Personas Andes Petroleum" s-data-type="String" b-allow-letters="TRUE" b-allow-whitespace="TRUE" s-allow-other-chars="_#-" i-maximum-length="2000" --><textarea rows="2" name="PersonasAEC" cols="68"></textarea></td>
  </tr>
  <tr>
    <td width="84" height="48">Personas Contratistas :</td>
    <td width="568" height="48" colspan="5">
    <!--webbot bot="Validation" s-display-name="Perosnas Contratistas" s-data-type="String" b-allow-letters="TRUE" b-allow-whitespace="TRUE" s-allow-other-chars="#-_" i-maximum-length="2000" --><textarea rows="2" name="Personascontract" cols="68"></textarea></td>
  </tr>
  <tr>
    <td width="84" height="36">Personas Terceros :</td>
    <td width="568" height="36" colspan="5">
    <!--webbot bot="Validation" s-display-name="Personas Terceras" s-data-type="String" b-allow-letters="TRUE" b-allow-whitespace="TRUE" s-allow-other-chars="-#" i-maximum-length="2000" --><textarea rows="2" name="Personasthird" cols="68"></textarea></td>
  </tr>
  <tr>
    <td width="84" height="36">Vehiculos :</td>
    <td width="568" height="36" colspan="5">
    <!--webbot bot="Validation" s-display-name="Vehiculos" s-data-type="String" b-allow-letters="TRUE" b-allow-digits="TRUE" b-allow-whitespace="TRUE" s-allow-other-chars="-#_" i-maximum-length="2000" --><textarea rows="2" name="Vehiculos" cols="68"></textarea></td>
  </tr>
  <tr>
    <td width="84" align="left" height="22">
    <p>Placa :</td>
    <td width="568" align="left" height="22" colspan="5">
    <!--webbot bot="Validation" s-display-name="Placa" s-data-type="String" b-allow-letters="TRUE" b-allow-digits="TRUE" b-allow-whitespace="TRUE" s-allow-other-chars="#-_" i-maximum-length="250" --><input name="Placa" type="text"  size="80" maxlength="250"></td>
  </tr>
  ...
  <tr>
    ...
    <td width="568" align="left" height="31" colspan="5">
    <!--webbot bot="Validation" s-display-name="Daños_Ocasionados" s-data-type="String" b-allow-letters="TRUE" b-allow-digits="TRUE" b-allow-whitespace="TRUE" s-allow-other-chars="#-_" i-maximum-length="2000" --><textarea rows="2" name="Danos" cols="68"></textarea></td>
  </tr>
  <tr>
    <td width="84" align="left" height="31">
    <span lang="es-ec">Dueño Equipo/Material :</span></td>
    <td width="568" align="left" height="31" colspan="5">
    <!--webbot bot="Validation" s-display-name="Dueño Equipo Material" s-data-type="String" b-allow-letters="TRUE" b-allow-digits="TRUE" b-allow-whitespace="TRUE" s-allow-other-chars="#-_" i-maximum-length="2000" --><textarea rows="2" name="Material" cols="68"></textarea></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    Anexos :</td>
    <td width="568" align="left" height="22" colspan="5">
    <!--webbot bot="Validation" s-display-name="Anexos" s-data-type="String" b-allow-letters="TRUE" b-allow-digits="TRUE" b-allow-whitespace="TRUE" s-allow-other-chars="." i-maximum-length="2500" --><textarea rows="2" name="Anexos" cols="63"></textarea><input type="button" onclick="gettext()" value="Ver" name="B1"><br>
  ...
  <tr>
    ...
    Costo :</td>
    <td width="568" align="left" height="22" colspan="5">
    <!--webbot bot="Validation" s-data-type="Integer" s-number-separators="x" b-value-required="TRUE" i-minimum-length="1" i-maximum-length="15" s-validation-constraint="Greater than or equal to" s-validation-value="0" --><input name="Costo" type="text"  size="10" maxlength="15" value="0"></td>
  </tr>
  </table>
