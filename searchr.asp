...
<form method="POST" action="searchr.asp?action=search" name="FrontPage_Form1" onsubmit="return FrontPage_Form1_Validator(this)" language="JavaScript">
  <table style="border-collapse: collapse" bordercolor="#111111" cellpadding="0" cellspacing="0" width="652" height="396">
  <tr>
  ...
  <tr>
    <td width="84" height="31">Provincia :</td>
    ...
    <td width="100" height="31" align="right">
  ...
  <tr>
    <td width="84" height="48">Clasificación de la Información:</td>
...
%>
  <tr>
    <td bgcolor="#E7FEE0" width="65%"><%=RS.Fields("REFERENCIA")%>&nbsp;</td>
    <td bgcolor="#E7FEE0" width="15%"><%=RS.Fields("FECHA")%>&nbsp;</td>
    <td bgcolor="#E7FEE0" width="10%"><%=RS.Fields("HORA")%>&nbsp;</td>
    <td bgcolor="#E7FEE0" align="center" width="10%"><a target="_blank" href="view.asp?action=view&codigo=<%=RS.Fields("CODIGO")%>">
