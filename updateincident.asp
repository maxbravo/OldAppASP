...
<table style="border-collapse: collapse" bordercolor="#111111" cellpadding="0" cellspacing="0" width="660" height="585">
  <tr>
    ...
    <!--webbot bot="Validation" s-data-type="String" b-allow-letters="TRUE" b-allow-digits="TRUE" b-allow-whitespace="TRUE" b-value-required="TRUE" i-minimum-length="1" i-maximum-length="300" --><input name="Referencia" type="text"  size="80" maxlength="300" value="<%=Referencia%>"></td>
  </tr>
  <tr>
    ...
    <!--webbot bot="Validation" s-data-type="String" b-allow-digits="TRUE" s-allow-other-chars=":" b-value-required="TRUE" i-minimum-length="1" i-maximum-length="5" --><input name="Hora" type="text"  size="10" maxlength="5" value="<%=Hora%>"></td>
  ...
  <tr>
    ...
    <!--webbot bot="Validation" s-data-type="String" b-allow-letters="TRUE" b-allow-digits="TRUE" b-allow-whitespace="TRUE" s-allow-other-chars="#-" b-value-required="TRUE" i-minimum-length="1" i-maximum-length="500" --><textarea rows="3" name="Lugar" cols="68"><%=Lugar%></textarea></td>
  </tr>

  <tr>
    <td width="84" height="32"><span lang="es-ec">Elaborado por :</span></td>
    <td width="526" height="32" colspan="5">
    <!--webbot bot="Validation" s-data-type="String" b-allow-letters="TRUE" b-allow-digits="TRUE" b-allow-whitespace="TRUE" s-allow-other-chars="-#" b-value-required="TRUE" i-minimum-length="1" i-maximum-length="250" --><textarea rows="1" name="Razon" cols="68"><%=Razon%></textarea></td>
  </tr>

  <tr>
    <td width="84" height="32"><span lang="es-ec">Reportado a :</span></td>
    <td width="526" height="32" colspan="5">
    <!--webbot bot="Validation" s-data-type="String" b-allow-letters="TRUE" b-allow-digits="TRUE" b-allow-whitespace="TRUE" s-allow-other-chars="-#" b-value-required="TRUE" i-minimum-length="1" i-maximum-length="250" --><input name="Reportadoa" type="text"  size="29" maxlength="250" value="<%=Reportadoa%>"></td>
  </tr>

  <tr>
    <td width="84" height="32">Reportado por :</td>
    <td width="176" height="32">
    <!--webbot bot="Validation" s-data-type="String" b-allow-letters="TRUE" b-allow-digits="TRUE" b-allow-whitespace="TRUE" s-allow-other-chars="#-" b-value-required="TRUE" i-minimum-length="1" i-maximum-length="250" --><input name="Fuente" type="text"  size="29" maxlength="250" value="<%=Fuente%>"></td>
    <td width="93" height="32" align="right">
  ...
  <tr>
    ...
    <!--webbot bot="Validation" s-data-type="String" b-allow-letters="TRUE" b-allow-digits="TRUE" b-allow-whitespace="TRUE" s-allow-other-chars="#-_:." b-value-required="TRUE" i-minimum-length="1" i-maximum-length="2000" --><textarea rows="3" name="Descripcion" cols="68"><%=Descripcion%></textarea></td>
  </tr>
  <tr>
    ...
    <!--webbot bot="Validation" s-data-type="String" b-allow-letters="TRUE" b-allow-digits="TRUE" b-allow-whitespace="TRUE" s-allow-other-chars="#-" i-maximum-length="2000" --><textarea rows="2" name="Seguimiento" cols="68"><%=Seguimiento%></textarea></td>
  </tr>
  <tr>
    <td width="84" align="left" height="31">
    <span lang="es-ec">Acciones Tomadas :</span></td>
    <td width="568" align="left" height="31" colspan="5">
    <!--webbot bot="Validation" s-data-type="String" b-allow-letters="TRUE" b-allow-digits="TRUE" b-allow-whitespace="TRUE" s-allow-other-chars="#-" i-maximum-length="2000" --><textarea rows="2" name="Acciones" cols="68"><%=Acciones%></textarea></td>
  </tr>  
  <tr>
    <td width="84" height="36">Personas AdPetro :</td>
    <td width="568" height="36" colspan="5">
    <!--webbot bot="Validation" s-data-type="String" b-allow-letters="TRUE" b-allow-digits="TRUE" b-allow-whitespace="TRUE" s-allow-other-chars="#-" i-maximum-length="2000" --><textarea rows="2" name="PersonasAEC" cols="68"><%=PersonasAEC%></textarea></td>
  </tr>
  <tr>
    <td width="84" height="36">Personas Contracts :</td>
    <td width="568" height="36" colspan="5">
    <!--webbot bot="Validation" s-data-type="String" b-allow-letters="TRUE" b-allow-digits="TRUE" b-allow-whitespace="TRUE" s-allow-other-chars="-#" i-maximum-length="2000" --><textarea rows="2" name="Personascontract" cols="68"><%=Personascontract%></textarea></td>
  </tr>
  <tr>
    <td width="84" height="36">Personas Third :</td>
    <td width="568" height="36" colspan="5">
    <!--webbot bot="Validation" s-data-type="String" b-allow-letters="TRUE" b-allow-digits="TRUE" b-allow-whitespace="TRUE" s-allow-other-chars="#-" i-maximum-length="2000" --><textarea rows="2" name="Personasthird" cols="68"><%=Personasthird%></textarea></td>
  </tr>
  <tr>
    <td width="84" height="36">Vehiculos :</td>
    <td width="568" height="36" colspan="5">
    <!--webbot bot="Validation" s-data-type="String" b-allow-letters="TRUE" b-allow-digits="TRUE" b-allow-whitespace="TRUE" s-allow-other-chars="#-_" i-maximum-length="2000" --><textarea rows="2" name="Vehiculos" cols="68"><%=Vehiculos%></textarea></td>
  </tr>
  <tr>
    <td width="84" align="left" height="22">
    <p>Placa :</td>
    <td width="568" align="left" height="22" colspan="5">
    <!--webbot bot="Validation" s-data-type="String" b-allow-letters="TRUE" b-allow-digits="TRUE" b-allow-whitespace="TRUE" s-allow-other-chars="-#_" i-maximum-length="250" --><input name="Placa" type="text"  size="80" maxlength="250" value="<%=Placa%>"></td>
  </tr>
  ...
  <tr>
    ...
    <td width="568" align="left" height="31" colspan="5">
    <!--webbot bot="Validation" s-data-type="String" b-allow-letters="TRUE" b-allow-digits="TRUE" b-allow-whitespace="TRUE" s-allow-other-chars="#-" i-maximum-length="2000" --><textarea rows="2" name="Danos" cols="68"><%=Danos%></textarea></td>
  </tr>
  <tr>
    <td width="84" align="left" height="31">
    <span lang="es-ec">Dueño Equipo/Material :</span></td>
    <td width="568" align="left" height="31" colspan="5">
    <!--webbot bot="Validation" s-data-type="String" b-allow-letters="TRUE" b-allow-digits="TRUE" b-allow-whitespace="TRUE" s-allow-other-chars="#-" i-maximum-length="2000" --><textarea rows="2" name="Material" cols="68"><%=Material%></textarea></td>
  </tr>    
  <tr>
  ...
  <tr>
    ...
    <!--webbot bot="Validation" s-data-type="Integer" s-number-separators="x" b-value-required="TRUE" i-minimum-length="1" i-maximum-length="15" --><input name="Costo" type="text"  size="10" maxlength="15" value="<%=Costo%>"></td>
  </tr>
  </table>
  <p><input type="submit" value="Grabar" name="Add"></p>
</form>
<form method="POST" action="asociarrecord.asp?Incidente=<%=Cod%>" name="Recor">
<input type="submit" name="Recor" value="Records Asociados">
</form>
...
'response.write sql
response.redirect "updateincident.asp?action=update&Codigo=" & Cod
