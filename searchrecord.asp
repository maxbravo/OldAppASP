...
<form method="POST" action="searchrecord.asp?action=search" name="FrontPage_Form1" onsubmit="return FrontPage_Form1_Validator(this)" language="JavaScript">
  <table style="border-collapse: collapse" bordercolor="#111111" cellpadding="0" cellspacing="0" width="657">
  <tr>
    <td width="89" height="32"><span lang="es-ec">Fecha Desde :</span></td>
  ...
  <tr>
    <td width="89" height="22">Provincia :</td>
  ...
  <tr>
    <td width="89" height="22">Cuidad :</td>
    <td width="189" height="22">
  ...
  <tr>
    <td width="89" height="22">Estado :</td>
    <td width="189" height="22">
  ...
  <tr>
    <td width="89" height="22"><span lang="es-ec">Nombre : </span></td>
    <td width="189" height="22">
  ...
  <tr>
    <td width="89" height="22"><span lang="es-ec">ID :</span></td>
    <td width="189" height="22">
  ...
  <tr>
    <td width="89" align="left" height="22">
    Fuente :</td>
  ...
  <tr>
    <td width="89" height="22"><span lang="es-ec">Lugar :</span></td>
...
%>
  <tr>
    ...
    <td bgcolor="#E7FEE0" align="center" width="10%"><a target="_blank" href="updaterecord.asp?action=update&codigo=<%=RS.Fields("CODIGO")%>">
    <img src="images/edit.gif" border="0"></a></td>
    <td bgcolor="#E7FEE0" align="center" width="10%"><a href="searchrecord.asp?action=delete&codigo=<%=RS.Fields("CODIGO")%>">
...
Conex.Open ConString
Set RS = Server.CreateObject("ADODB.RecordSet")
sql = "delete RECORD where CODIGO = " & Cod
RS.Open sql, Conex, 1
Conex.Close
Set RS = Nothing
Set Conex = Nothing
...
<br>
<br>
<table border="1" cellspacing="1" bordercolorlight="#FFFFFF" bordercolordark="#FFFFFF" style="border-width: 1px">
  <tr>
  
    <td width="100%" colspan="2">
		<p>Está seguro que desea eliminar el record de número <%=Cod%> ?</p><br></td>
  </tr>
  <tr>
  
    <td width="50%">
		<form method="POST" action="searchrecord.asp?action=delete1&codigo=<%=Cod%>">
		<input type="submit" value="Eliminar" name="Eliminar"> </p>
	</form>    
    
    </td>
    <td width="50%">
		<form method="POST" action="searchrecord.asp?action=">
