...
Incidente = Request.QueryString("Incidente")
...
<form method="POST" action="asociarrecord.asp?action=search&Incidente=<%=Incidente%>" name="FrontPage_Form1" onsubmit="return FrontPage_Form1_Validator(this)" language="JavaScript">
  ...
  <tr>
    ...
    <!--webbot bot="Validation" s-data-type="String" b-allow-letters="TRUE" b-allow-digits="TRUE" s-allow-other-chars="/-" i-maximum-length="11" --><input name="FechaD" type="text" onBlur="checkdate(this)" size="12" maxlength="11"><span lang="es-ec">dd/mm/yyyy</span> </td>
    <td width="100" height="32" align="right">
    <span lang="es-ec">Fecha Hasta :</span></td>
    <td width="237" height="32">
    <!--webbot bot="Validation" s-data-type="String" b-allow-letters="TRUE" b-allow-digits="TRUE" s-allow-other-chars="/-" i-maximum-length="11" --><input name="FechaH" type="text" onBlur="checkdate(this)" size="12" maxlength="11"><span lang="es-ec">dd/mm/yyyy</span> </td>
  </tr>
  <tr>
...
sql = "select CODIGO,FECHA,NOMBRE from RECORD where codigo not in(select record from incidenterecord where incidente = " & Incidente & ")"
if Nombre <> "" Then
...
&nbsp;<p class="banner_blue">
Resultados de la Búsqueda de Records</p>
<table border="1" cellspacing="0" width="100%" id="AutoNumber1" bordercolorlight="#FFFFFF" bordercolordark="#FFFFFF" style="border-width: 0; border-collapse:collapse" bordercolor="#111111" cellpadding="0">
  <tr>
    ...
    <td width="10%">
    <p align="center" class="banner_green">Asociar</td>
    <td width="10%">
...
%>
  <tr>
    ...
    <td bgcolor="#E7FEE0" align="center" width="10%"><a href="asociarrecord.asp?action=asociar&codigo=<%=RS.Fields("CODIGO")%>&Incidente=<%=Incidente%>">
...
Conex.Open ConString
Set RS = Server.CreateObject("ADODB.RecordSet")
sql = "select * from record where codigo in(select record from incidenterecord where incidente = " & Incidente & ")"
RS.Open sql, Conex, 1
%>

&nbsp;<p class="banner_blue">
Records Asociados al Incidente Código: <%=Incidente%></p>
<table border="1" cellspacing="0" width="100%" id="AutoNumber1" bordercolorlight="#FFFFFF" bordercolordark="#FFFFFF" style="border-width: 0; border-collapse:collapse" bordercolor="#111111" cellpadding="0">
  <tr>
    <td width="10%">
    <p class="banner_green">Código</td>
    ...
    <p class="banner_green">Nombre</td>
    <td width="5%">
    <p align="center" class="banner_green">Eliminar</td>
    <td width="5%">
    <p align="center" class="banner_green">View</td>
  </tr>
<%
...
%>
  <tr>
    ...
    <td bgcolor="#E7FEE0" width="20%"><%=RS.Fields("FECHA")%>&nbsp;</td>
    <td bgcolor="#E7FEE0" width="50%"><%=RS.Fields("Nombre")%>&nbsp;</td>
    <td bgcolor="#E7FEE0" align="center" width="10%"><a href="asociarrecord.asp?action=delete&codigo=<%=RS.Fields("CODIGO")%>&Incidente=<%=Incidente%>">
...
<%
if action = "asociar" then
Codigo = Request.QueryString("codigo")
'Update de los datos
Set Conex = Server.CreateObject ("ADODB.Connection")
Conex.Open ConString
Set RS = Server.CreateObject("ADODB.RecordSet")
sql = "INSERT INTO INCIDENTERECORD VALUES(" & Incidente & "," & Codigo & ")"
RS.Open sql, Conex, 1
Conex.Close
Set RS = Nothing
Set Conex = Nothing
response.redirect "asociarrecord.asp?Incidente="&Incidente
end if
%>
...
Conex.Open ConString
Set RS = Server.CreateObject("ADODB.RecordSet")
sql = "DELETE INCIDENTERECORD Where Incidente=" & Incidente & " and record= " & Codigo
RS.Open sql, Conex, 1
Conex.Close
Set RS = Nothing
Set Conex = Nothing
