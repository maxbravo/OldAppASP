...
<form method="POST" action="search.asp?action=search" name="FrontPage_Form1" onsubmit="return FrontPage_Form1_Validator(this)" language="JavaScript">
...
%>
  <tr>
    ...
    <td bgcolor="#E7FEE0" align="center" width="10%"><a href="search.asp?action=delete&codigo=<%=RS.Fields("CODIGO")%>">
...
%>
<form method="POST" action="search.asp?action=delete1&codigo=<%=Cod%>">
